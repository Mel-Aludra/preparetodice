 ...
 */
final class Version20200923170825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game_character_lore_block (game_character_id INT NOT NULL, lore_block_id INT NOT NULL, INDEX IDX_898A0290FFE68A1B (game_character_id), INDEX IDX_898A0290715F219A (lore_block_id), PRIMARY KEY(game_character_id, lore_block_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
