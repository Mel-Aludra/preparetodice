...
use App\Repository\ResourceAlterationRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=ResourceAlterationRepository::class)
 */
class ResourceAlteration extends Entity
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=StatusEffect::class, inversedBy="resourceAlterations")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Gear::class, inversedBy="resourceAlterations")
     */
    private $gear;

    /**
     * @ORM\ManyToOne(targetEntity=Passive::class, inversedBy="resourceAlterations")
     */
    private $passive;
