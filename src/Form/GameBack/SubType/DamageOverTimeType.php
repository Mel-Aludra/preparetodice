...
class DamageOverTimeType extends AbstractType
{
    ...
    public function __construct(ResourceRepository $resourceRepository, DamageNatureRepository $damageNatureRepository, GameEnv $gameEnv)
    {
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => DamageOverTime::class,
        ]);
    }
}
